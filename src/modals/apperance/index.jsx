...
import { setBackgroundColor, setColor } from "~/store/apperance/actions";

export default function Apperance() {
  const { backgroundColor, color } = useApperance()
  ...
  return (
    <div className='w-[600px]'>
      ...
      <div className="p-8 pt-0">
        ...
        <h6 className="text-color[color:var(--color-base-secondary)] mb-1 leading-5 text-[13px] font-bold">Background</h6>
        <div className="py-1 px-3 mb-3 gap-1 grid grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
          <button
            onClick={() => {
              setColor({
                ...color,
            ...
            className={cn("h-16 px-5 bg-white text-[#0f1419] border-1 border-white/10 font-bold", {
          ...
          <button
            ...
            className={cn("h-16 px-5 bg-[#15202b] text-[#f7f9f9] border-1 border-white/10 font-bold", {
          ...
          <button
            ...
            className={cn("h-16 px-5 bg-black text-[#f7f9f9] border-1 border-white/10 font-bold", {
